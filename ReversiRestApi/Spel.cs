...
namespace ReversieISpelImplementatie.Model
{
    public class Spel : ISpel
    {
        ...
        public Kleur OverwegendeKleur()
        {
            var aantalWit = 0;
            var aantalZwart = 0;
            for (var rijZet = 0; rijZet < bordOmvang; rijZet++)
            for (var kolomZet = 0; kolomZet < bordOmvang; kolomZet++)
        ...
        public void DoeZet(int rijZet, int kolomZet)
        {
            ...
            bool heeftOmgedraaid = false;

            for (var i = 0; i < 8; i++)
            {
                var result = DraaiStenenVanTegenstanderInOpgegevenRichtingOmIndienIngesloten(
                    rijZet,
                    kolomZet,
                    AandeBeurt,
                    richting[i, 0],
                ...
                heeftOmgedraaid = heeftOmgedraaid ? heeftOmgedraaid : result;
            }
        ...
        {
            int rij, kolom;
            var kleurTegenstander = GetKleurTegenstander(kleurZetter);
            ...
            var aantalNaastGelegenStenenVanTegenstander = 0;
        ...
        private bool DraaiStenenVanTegenstanderInOpgegevenRichtingOmIndienIngesloten(
            int rijZet,
            int kolomZet,
            Kleur kleurZetter,
            int rijRichting,
